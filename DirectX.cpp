...
LPDIRECT3DTEXTURE9 LoadTexture(std::string filename , D3DCOLOR transcolor)
{
	...
	D3DXCreateTextureFromFileEx(
		d3ddev , filename.c_str() , info.Width , info.Height , 1 , D3DPOOL_DEFAULT , D3DFMT_UNKNOWN , D3DPOOL_DEFAULT,  D3DX_DEFAULT , D3DX_DEFAULT , transcolor , &info , NULL , &texture) ;
...
void Initialize_Ball(float &vel)
{
	int random = 0;
	float speed = 0.7f;
	random = rand() % 2;
